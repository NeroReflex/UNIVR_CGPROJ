...
La relazione sull'integrazione si trova in [Integrazione](Integrazione.md).

## Relazione shadow mapping

La relazione sullo shadow mapping si trova in [Shadow Mapping](SHADOW_MAPPING.md).

## Esercizi

La descrizione degli esercizi svolti si trova in [Esercizi](ESERCIZI.md).
