...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        trans2 = glm::scale(trans2, glm::vec3(glm::sin((float)glfwGetTime()), glm::sin((float)glfwGetTime()), 1.0f));
        ...
        shaderProgram->uniformMat4x4("transform", trans1);
        CHECK_GL_ERROR(glDrawElements(GL_TRIANGLES, num_indices, GL_UNSIGNED_INT, 0));

        shaderProgram->uniformMat4x4("transform", trans2);
        CHECK_GL_ERROR(glDrawElements(GL_TRIANGLES, num_indices, GL_UNSIGNED_INT, 0));
