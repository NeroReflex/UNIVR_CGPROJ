...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shaderProgram->uniformVec3("material.ambient", glm::vec3(1.0f, 0.5f, 0.31f));
        shaderProgram->uniformVec3("material.diffuse", glm::vec3(1.0f, 0.5f, 0.31f));
        shaderProgram->uniformVec3("material.specular", glm::vec3(0.5f, 0.5f, 0.5f));
