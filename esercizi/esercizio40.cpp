...
const char *fragmentShaderSource =
    ...
    "\n"
    "   color = vec4(ambientContrib * material.ambient + diffuseContrib * material.diffuse + specularContrib * material.specular, 1.0);\n"
    "}\0";
...
int main()
{
    ...
    const auto set_material = [&](const CubeMaterial& material) {
        shaderProgram->uniformVec3("material.ambient", material.ambient);
        shaderProgram->uniformVec3("material.diffuse", material.diffuse);
        shaderProgram->uniformVec3("material.specular", material.specular);
        shaderProgram->uniformFloat("material.shininess", material.shininess);
    };

    const auto default_material = CubeMaterial {
